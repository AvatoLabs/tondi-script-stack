...
fn get_opcode(instruction: &Instruction) -> Option<u8> {
    match instruction {
...
pub fn opcode_transformation( opcode: &u8, previous_opcode: Option<u8>, previous_digit: Option<u8>) -> Option<Option<u8>> {
...
mod tests {
    ...
    pub use tondi_script::define_pushable;
