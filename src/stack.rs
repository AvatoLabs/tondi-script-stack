...
use tondi_txscript::opcodes::OpCodeMetadata;
...
impl StackTracker {
    ...
    pub fn var(&mut self, size: u32, name: &str) -> StackVariable {
        let var = StackVariable::new( self.next_counter(), size );
        self.push(var);
        self.data.set_name(var, name);
        self.push_script(script!{});
    ...
    fn op(&mut self, op: OpCodeMetadata, consumes: u32, output: bool, name: &str ) -> Option<StackVariable> {
